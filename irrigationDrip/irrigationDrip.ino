...
/*
 ...
 data["Humidity"] = dhthumid;
 data["Temperature"] = dhttemp;
 data.printTo(nodemcu);
 jsonBuffer.clear();
 delay(2000);
 */
 str = String("Coming from Arduino:")+String("Temp:")+String(dhttemp)+String("Humidity:")+String(dhthumid);
 nodemcu.println(str);
